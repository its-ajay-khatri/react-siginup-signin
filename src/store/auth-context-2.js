...
export const AuthContextProvider = (props) => {
    ...
    let initialToken;
    if(tokenData){
        initialToken = tokenData.token;           //find an token if already exists 
    ...
    const loginHandler = (token, expirationTime) => {
        ...
        logoutTimer = setTimeout(logoutHandler, remainingTime);                  //automatically will logout the user after that session time ends
    };
